...
select *
from sales.products
where price >= 100000 and price <= 200000 --- Sem usar between


select *
from sales.products
where price between 100000 and 200000 --- Usando between
...
select *
from sales.products
where price < 100000 or price > 200000 --- Sem usar o NOT

select *
from sales.products
where price not between 100000 and 200000 --- Usando not
...
select *
from sales.products
where brand = 'HONDA' or brand = 'TOYOTA' or brand = 'RENAULT' --- Sem usar o IN

select *
from sales.products
where brand in ('HONDA', 'TOYOTA', 'RENAULT') --- Usando o IN
...
where first_name like '%ANA%' --- O coringa % define por onde ele busca o termo 'ANA'
...
select distinct first_name
from sales.customers
where first_name ilike 'ana%' --- O comando ILIKE não se importa com o formato (maiúsculo, minúsculo) do termo 'ANA'
